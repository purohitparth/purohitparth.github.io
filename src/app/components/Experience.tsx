...
const jobs = [
  {
    ...
    highlights: [
      ...
      "Collaborate full-stack with Node.js and Spring Boot backend teams to design and optimize REST API contracts, reduce payload latency, and align on data schemas across MySQL and PostgreSQL.",
  ...
  },
  {
    ...
    tag: "3 yrs",
    highlights: [
      "Delivered full-stack features across Verizon's enterprise web platform — owning React / Next.js / Angular frontends, RESTful API integrations, and backend data flows across MySQL, Oracle, and PostgreSQL, reducing feature delivery time by ~25%.",
      ...
      "Engineered interactive geospatial network visualization tools using LeafletJS, ArcGIS, and KonvaJS — enabling real-time field operations decision-making for Verizon network teams.",
      "Optimized full-stack API performance by redesigning REST contracts and implementing efficient state management with Redux and NgRx, cutting end-to-end latency by ~20%.",
      "Owned Docker containerization and GitLab CI/CD pipelines for frontend and backend services — reducing release downtime by ~40% and enabling zero-downtime deployments.",
  ...
  },
  {
    ...
    tag: "6 mos",
    highlights: [
      "Built secure, high-compliance banking web applications end-to-end using Angular 12, NgRx, TypeScript on the frontend and Java Spring Boot REST APIs on the backend — meeting strict enterprise security and regulatory standards.",
      "Designed and developed a reusable Angular component library with shared services and NgRx state patterns, reducing cross-team development effort by ~20% and ensuring UI consistency across banking modules.",
      "Integrated frontend with Spring Boot microservices — designing API contracts, handling authentication flows, and managing async data pipelines for real-time banking transactions.",
      "Drove significant frontend performance gains via lazy loading, AOT compilation, and optimized change detection cycles — reducing initial load time by ~25% for high-traffic banking dashboards.",
      "Established unit and integration test coverage using Jasmine and Karma across Angular components and services, reducing production defect rate and improving release confidence.",
    ],
  },
  {
