...
export const metadata: Metadata = {
  ...
  keywords: ["React", "Next.js", "TypeScript", "Frontend Engineer", "Agentic AI", "Micro Frontend", "LangChain", "LangGraph"],
  authors: [{ name: "Parth Purohit" }],
  openGraph: {
    title: "Parth Purohit | Senior Front-End Engineer",
    description: "Senior Front-End Engineer specializing in React, Next.js, and Agentic AI applications.",
    type: "website",
